...
public class User {
    ...
    public boolean hasAutoGeneratedPassword(){
        return   GiiftyPreferences.getInstance().hasAutoGeneratedPassword();
    }
    public void setHasAutoGeneratedPassword(boolean hasSigned){
        GiiftyPreferences.getInstance().setHasAutoGeneratedPassword(hasSigned);
    }
